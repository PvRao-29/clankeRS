...
The generated header is written to `$OUT_DIR/clankers.h` when building this crate
(and synced into `cpp/include/clankers/` when built from the clankeRS tree). See
[`cpp/README.md`](https://github.com/PvRao-29/clankeRS/blob/main/cpp/README.md) for the idiomatic C++17 wrappers.
