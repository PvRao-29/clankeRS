...
All clankeRS crates are published on [crates.io](https://crates.io/crates/clankers) at **v0.1.1**. You do not need to clone the repository to use the SDK, scaffold projects, or run the CLI.
